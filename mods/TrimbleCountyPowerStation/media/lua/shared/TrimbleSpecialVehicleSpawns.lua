...
VehicleZoneDistribution.firecien.vehicles["Base.PickUpVanLightsFire"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.firecien.vehicles["Base.PickUpTruckLightsFire"] = {index = -1, spawnChance = 100};
...
VehicleZoneDistribution.utilidad.vehicles["Base.VanSeats"] = {index = -1, spawnChance = 25};
VehicleZoneDistribution.utilidad.vehicles["Base.Van"] = {index = -1, spawnChance = 20};
VehicleZoneDistribution.utilidad.vehicles["Base.StepVan"] = {index = -1, spawnChance = 25};
VehicleZoneDistribution.utilidad.vehicles["Base.PickUpTruck"] = {index = -1, spawnChance = 20};
VehicleZoneDistribution.utilidad.vehicles["Base.PickUpVan"] = {index = -1, spawnChance = 20};
VehicleZoneDistribution.utilidad.spawnRate = 50;
...
VehicleZoneDistribution.accidenteuno = VehicleZoneDistribution.accidenteuno or {};
VehicleZoneDistribution.accidenteuno.vehicles = VehicleZoneDistribution.accidenteuno.vehicles or {};
VehicleZoneDistribution.accidenteuno = {};
VehicleZoneDistribution.accidenteuno.vehicles = {};
VehicleZoneDistribution.accidenteuno.vehicles["Base.CarNormal"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.SmallCar"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.SmallCar02"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.CarTaxi"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.CarTaxi2"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.PickUpTruck"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.PickUpVan"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.CarStationWagon"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.CarStationWagon2"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.VanSeats"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.Van"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.StepVan"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.ModernCar"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.vehicles["Base.ModernCar02"] = {index = -1, spawnChance = 100};
VehicleZoneDistribution.accidenteuno.chanceToSpawnBurnt = 100;
VehicleZoneDistribution.accidenteuno.spawnRate = 100;
VehicleZoneDistribution.accidenteuno.chanceToPartDamage = 100;
VehicleZoneDistribution.accidenteuno.baseVehicleQuality = 0.2;
VehicleZoneDistribution.accidenteuno.chanceToSpawnKey = 10;
end